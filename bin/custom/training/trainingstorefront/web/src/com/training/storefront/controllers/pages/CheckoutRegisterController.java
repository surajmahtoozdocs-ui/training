...
public class CheckoutRegisterController extends AbstractTrainingRegisterPageController
{
	@Override
	...
	public String doCheckoutRegister(final TrainingRegisterForm form, final BindingResult bindingResult, final Model model,
