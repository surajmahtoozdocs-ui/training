...
public class RegisterPageController extends AbstractTrainingRegisterPageController
{
	...
	public String doRegister(final TrainingRegisterForm form, final BindingResult bindingResult, final Model model,
