...
public abstract class AbstractTrainingRegisterPageController extends AbstractRegisterPageController
{
	private static final Logger LOGGER = Logger.getLogger(AbstractTrainingRegisterPageController.class);
	...
	{
		final String view = super.getDefaultRegistrationPage(model);
